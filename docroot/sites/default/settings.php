 ...
 * @endcode
 */
$settings['hash_salt'] = '9OEorcrq7KTuK-bbeDKXO_UTIha5-2KkOxv9zWKejpjvvZRANM7tMsihctQPRprAFQvgQZa7PQ';
...
$config_directories['sync'] = 'sites/default/files/config_M0IfBGITI_hplCJneOg_lASSe563Q3N4j_auWbq-mQz8s9gvDTb7nDM3kiQ7fg7t2N4zgBkheA/sync';
/**
...
$settings_local = DRUPAL_ROOT . '/' . \Drupal\Core\DrupalKernel::findSitePath($request) . '/settings.local.php';
 ...
 ******************************************************/
require DRUPAL_ROOT . "/modules/contrib/devinci/devinci.environments.inc";
...
$settings['environment_indicator_git_support'] = FALSE;
...
//$settings['stage_file_proxy_origin'] = 'http://my-live-site.com';
...
switch(ENVIRONMENT) {
    ...
    case 'local':
        ...
        $settings['features_master_temp_disabled_modules'] = array(
                'syslog',
        );
        ...
        $settings['environment_indicator_git_support'] = TRUE;
        break;
    ...
    case 'test':
        ...
        $settings['page_cache_maximum_age'] = 900;
        $settings['cache'] = 1;
